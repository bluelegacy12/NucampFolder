...
-- A: Create a new table that includes employees and the categories they are experts in as the two collumns
-- Q: What type of relationship is this? (e.g. 1-1, 1-many, or many-to-many?)
-- A: Many to many. Each employee can have multiple categories and each category can have multiple employees.
...
INSERT INTO employees_categories (employee_id, category_id)
SELECT employee_id, 4 FROM employees WHERE city = 'London';
